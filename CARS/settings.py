...
SECRET_KEY = 'django-insecure-brr(jpy_h^1ysq=n+3n#0u#v(ba2(msi2@5hi9u608-6vv1yke'
...
INSTALLED_APPS = [
    ...
    'citizens',
    'citizens.templatetags.custom_filters',
]
...
# Use a separate session for Django Admin
ADMIN_SESSION_COOKIE_NAME = "admin_sessionid"
ADMIN_CSRF_COOKIE_NAME = "admin_csrftoken"

# Check if request is for admin panel and change session storage
